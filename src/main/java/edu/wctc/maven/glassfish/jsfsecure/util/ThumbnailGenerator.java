...
/**
 * This code reduces an image in a number of steps to produce a high quality 
 * thumbnail image. It uses a weighted stepping method so that the earlier 
 * steps are larger than the later ones, this works better because if you 
 * imagine a 200px wide image that you're reducing by 100px, it's a much 
 * bigger change (relative to the image) than reducing a 1000px one to 900px.
 * 
 * @author   phil@philreeve.com (original version)
 * @author   Jim Lombardo (updated to modern techniques)
 * @version  2.00
 */
    ...
    */
    public String createThumbnail(String inFilename, String outFilename, int largestDimension) {
        try
        {
            ...
            {
                    Image inImage = new ImageIcon(inFilename).getImage();
...
//                            os.close();
    ...
    public static void main(String[] args) {
        ...
        String msg = th.createThumbnail("/auction/imgvault/fender_amp.jpg", 
                "/auction/imgvault/fender_amp-thumb.jpg", 200);
